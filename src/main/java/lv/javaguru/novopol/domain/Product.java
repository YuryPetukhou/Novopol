...
public class Product extends Entity {
	...
	public String toString() {
		return "Product [sizeOne=" + sizeOne + ", sizeTwo=" + sizeTwo + ", sizeThree=" + sizeThree + ", strengthGrade="
				+ strengthGrade + ", wearResistanceGrade=" + wearResistanceGrade + ", codeNumber=" + codeNumber
				+ ", priceDisplayed=" + priceDisplayed + ", priceReal=" + priceReal + ", numberInPack=" + numberInPack
				+ ", metersInPack=" + metersInPack + ", collection=" + collection + ", producer=" + producer
				+ ", supplier=" + supplier + ", surfaceType=" + surfaceType + ", thumbnailImageUri=" + thumbnailImageUri
				+ ", fullsizeImageUri=" + fullsizeImageUri + "]";
	}
