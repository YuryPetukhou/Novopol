...
public class KeywordSQLFactory extends SQLStatementFactory{
	...
	private static final String SQL_INSERT_KEYWORD = "INSERT INTO public.keywords (id,created_dt, updated_dt, created_by,updated_by,keyword) VALUES (uuid_generate_v4(),now(),now(),'Auto','Auto',?)";
