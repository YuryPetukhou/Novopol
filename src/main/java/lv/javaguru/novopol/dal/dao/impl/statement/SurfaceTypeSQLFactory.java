...
public class SurfaceTypeSQLFactory extends SQLStatementFactory {
	private static final String SQL_GET_SURFACE_TYPE_BY_ID = "SELECT id FROM public.surface_types WHERE surface_type=?";
	...
	private static final String SQL_UPDATE_SURFACE_TYPE_BY_ID = "UPDATE public.surface_types SET updated_dt=now(), updated_by='Auto',surface_type=? WHERE id=?";
	private static final String SQL_DELETE_SURFACE_TYPE = "DELETE FROM public.surface_types WHERE surface_type=?";
